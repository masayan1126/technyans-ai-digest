...
export const translations = {
  ...
  ja: {
    ...
    quickLinks: 'クイックリンク',
    categories: 'カテゴリ',
    footerDescription: '忙しい毎日の中でAI情報のキャッチアップを頑張るあなたを、テクにゃん.と一緒に応援します。',
    ...
    featureTechnyanTitle: 'テクにゃん.と一緒に成長する',
    featureTechnyanDesc: '可愛いマスコット・テクにゃん.が、毎日のAIニュースチェックに癒しと楽しさをプラスします。',
    ...
    // Gallery Page
    galleryTitle: 'テクにゃん.ギャラリー',
    galleryDescription: 'コーディングする猫のチームに会おう！それぞれのテクにゃん.が、テクノロジーの世界に独自のスタイルをもたらします。',
    filterAll: 'すべて',
    filterBasic: 'ベーシック',
    ...
    categoryThemed: 'テーマ別',
    galleryNoResults: 'このカテゴリにテクにゃん.は見つかりませんでした。',
    galleryShowing: '表示中',
    galleryOf: '/',
    galleryTechnyans: '件のテクにゃん.',
    galleryCopyright: 'すべてのテクにゃん.画像は著作権で保護されています。無断使用を禁止します。',
    ...
    notFoundMessage: 'おっと！テクにゃん.がお探しのページを見つけられませんでした。',
    ...
    termsSection3Content1: '当サイトのすべてのオリジナルコンテンツ（記事、画像、グラフィック、ロゴ、テクにゃん.キャラクターを含むがこれらに限定されない）は、Technyan\'s AI Digestsの財産であり、著作権法により保護されています。',
