---
title: グーグルの脅威にさらされるOpenAI、巨額出資する孫正義の資産は約7750億円減少
description: GoogleのGemini 3発表を受け、OpenAIへの巨額投資を進めるソフトバンクグループの株価が急落。孫正義氏の資産は約50億ドル（約7750億円）減少し、ソフトバンク株はピークから40%下落した。
date: 2025-11-26
category: Other
tags:
  - OpenAI
...
1. **競争激化**: Google、Anthropic、Metaなど競合他社の追い上げ
2. **資金調達**: 投資コミットメントと実際の調達能力のギャップ
3. **収益化の不確実性**: OpenAIの黒字化時期が不透明
4. **市場センチメント**: AI銘柄全体への投資家の警戒感

AI業界への投資熱は続いているものの、今回の株価急落は、AIバブルのリスクを市場が再認識し始めた兆候かもしれません。

## 情報源

- [Forbes Japan - グーグルの脅威にさらされるOpenAI](https://news.yahoo.co.jp/articles/3435ae8ea74777394750bf22ea2e370a3d7cdebe)
